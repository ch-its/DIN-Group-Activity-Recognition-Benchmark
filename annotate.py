...
def ann(seqno,filepath):
    ...
    with open("data/volleyball_dataset/"+str(seqno) + "/annotations.txt") as file_in:
    ...
    height = 0
    width = 0
    if not os.path.isdir("result_din_vbd4_res"):
        os.makedirs("result_din_vbd4_res")
    print("length of d",len(d))
    print("length of lines_out",len(lines_out))
    for i in d:
        
        imgpath = "data/volleyball_dataset/"+str(seqno)+"/"+str(i)+"/"+str(i)+".jpg" 
        ...
        image = cv2.putText(image, ACTIVITIES[int(lines_out[ans_cnt][0][0])], org, font, 
                        fontScale, color, thickness, cv2.LINE_AA)
        ...
        image = cv2.putText(image, ACTIVITIES[int(lines_out[ans_cnt][1][0])], org, font, 
                        fontScale, color, thickness, cv2.LINE_AA)
        #print("result_"+"seq"+seq+"/frame" + i + ".jpg")
        cv2.imwrite("result_din_vbd4_res/"+ str(i) + ".jpg",image)
